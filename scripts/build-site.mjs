...
// --- Helper: HTML shell ---
function htmlPage({ title, description, canonical, body, extra = '' }) {
...
function buildSitemap() {
  ...
  const urls = [
    ...
    ...templates.map(t => ({ loc: `/templates/${t.slug}.html`, priority: '0.8' })),
    ...
    ...scenarios.map(s => ({ loc: `/scenarios/${s.slug}.html`, priority: '0.6' })),
    { loc: '/tools/prompt-builder.html', priority: '0.6' },
    { loc: '/tools/output-checker.html', priority: '0.6' },
    { loc: '/tools/reply-filter.html', priority: '0.6' },
    { loc: '/pages/about.html', priority: '0.4' },
    { loc: '/pages/contact.html', priority: '0.4' },
    { loc: '/pages/disclaimer.html', priority: '0.3' },
